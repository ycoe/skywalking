 ...
 * @author xuwenzhen
 */
public class GraphqlSupplierConstructorInterceptor implements InstanceMethodsAroundInterceptor {
    /**
    ...
    public void beforeMethod(EnhancedInstance objInst, Method method, Object[] allArguments, Class<?>[] argumentsTypes, MethodInterceptResult result) throws Throwable {
        if (ContextManager.isActive()) {
            allArguments[0] = new GraphqlApplierProxy<>((Supplier<Object>) allArguments[0], ContextManager.capture());
        }
    }
