...
public class MongoDBMethodInterceptorTest {
    ...
    private MongoDB3MethodInterceptor interceptor;
    ...
    public void setUp() throws Exception {
        ...
        interceptor = new MongoDB3MethodInterceptor();

        Config.Plugin.MongoDB.TRACE_PARAM = true;

        when(enhancedInstance.getSkyWalkingDynamicField()).thenReturn("mongodb1.tp.fdd:27017");
    ...
    private Method getExecuteMethod() {
        try {
            return MongoClient.class.getMethod("listDatabases");
